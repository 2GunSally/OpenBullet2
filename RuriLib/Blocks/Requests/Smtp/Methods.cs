...
public static class Methods
{
        ...
        string recipientName, string recipientAddress, string subject, string textBody, string htmlBody)
    {
        ...
        var bodyBuilder = new BodyBuilder { HtmlBody = htmlBody.Unescape(), TextBody = textBody.Unescape() };
        ...
        Dictionary<string, string> customHeaders, List<string> fileAttachments)
    {
        ...
        foreach (var header in customHeaders) message.Headers.Add(header.Key, header.Value);
    ...
    private static SmtpClient GetAuthenticatedClient(BotData data)
    {
        ...
        if (!client.IsAuthenticated) throw new Exception("Authenticate the SMTP client first!");
