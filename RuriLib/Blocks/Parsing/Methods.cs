...
public static class Methods
{
        ...
        bool urlEncodeOutput = false)
    {
        ...
        if (urlEncodeOutput) parsed = Uri.EscapeDataString(parsed);
    ...
    public static string QueryJsonToken(BotData data, string json, string jToken, string prefix = "",
        string suffix = "",
        bool urlEncodeOutput = false)
    {
    ...
    {
        var parsed =
            RegexParser.MatchGroupsToString(input, pattern, outputFormat,
