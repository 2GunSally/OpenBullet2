...
public static class Methods
{
    ...
    public static void SeleniumSelectByIndex(BotData data, FindElementBy findBy, string identifier, int index,
        int selectionIndex)
    {
        data.Logger.LogHeader();
    ...
    public static void SeleniumSelectByText(BotData data, FindElementBy findBy, string identifier, int index,
        string text)
    {
        data.Logger.LogHeader();
    ...
    public static void SeleniumScreenshotElement(BotData data, FindElementBy findBy, string identifier, int index,
        string fileName)
    {
        data.Logger.LogHeader();
    ...
    public static async Task SeleniumWaitForElement(BotData data, FindElementBy findBy, string identifier,
        int timeout = 30000)
    {
        data.Logger.LogHeader();
