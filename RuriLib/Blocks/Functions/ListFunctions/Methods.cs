...
public static class Methods
{
    ...
    [Block("Sorts a list alphabetically",
        extraInfo = "If the elements of the list are numeric values, set numeric to true")]
    ...
    [Block("Maps two lists into a dictionary",
        extraInfo = "For example [1,2] and [a,b] will be mapped into {(1,a), (2,b)}")]
    public static Dictionary<string, string> MapLists(BotData data, [Variable] List<string> list1,
        [Variable] List<string> list2)
    {
    ...
    [Block("Adds an item to a list",
        extraInfo =
            "If the index is negative, it will start from the end of the list. For example an index of -1 will add the item at the end of the list")]
    ...
    [Block("Removes an item from a list",
        extraInfo =
            "If the index is negative, it will start from the end of the list. For example an index of -1 will remove the item at the end of the list")]
    ...
    public static void RemoveAllFromList(BotData data, [Variable] List<string> list, StrComparison comparison,
        string term)
    {
        ...
        string separator = ":", bool autoTrim = true)
    {
        ...
        foreach (var item in list)
        {
            ...
            if (!string.IsNullOrEmpty(split[0])) dict[split[0]] = split[1];
        }
