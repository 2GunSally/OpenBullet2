...
public static class Methods
{
    ...
    public static async Task PuppeteerOpenBrowser(BotData data, string extraCmdLineArgs = "")
    {
        ...
        if (Utils.IsDocker()) args += " --no-sandbox";
        ...
        if (data.Proxy != null && data.UseProxy)
        {
            ...
            {
                var proxyType = data.Proxy.Type == ProxyType.Socks5
                    ? Yove.Proxy.ProxyType.Socks5
                    : Yove.Proxy.ProxyType.Socks4;
        ...
        var launchOptions = new LaunchOptions {
            ...
            IgnoredDefaultArgs = new[] { "--disable-extensions", "--enable-automation" },
        ...
        data.Logger.Log($"{(launchOptions.Headless ? "Headless " : "")}Browser opened successfully!",
            LogColors.DarkSalmon);
    }
