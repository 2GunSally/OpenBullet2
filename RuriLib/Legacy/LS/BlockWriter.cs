...
public class BlockWriter : StringWriter
{
    ...
    private bool Indented { get; }
    private Type Type { get; }
    private object Block { get; }
    ...
    /// <param name="property">
    ///     The name of the property of the block. If the value is the default one, it will not be written.
    ///     Do not set this parameter to always write the variable.
    /// </param>
    ...
    /// </summary>
    /// <param name="spacing">
    ///     The amount of spacing to perform. A spacing of value 1 means two blank space characters, 2 means
    ///     4 etc.
    /// </param>
    /// <returns></returns>
