...
/// <summary>
///     Represents a set of keys that can be checked in a OR/AND fashion and modifies the status of the BotData if
///     successful.
/// </summary>
...
/// <summary>
///     The returned status upon a successful check of the keys. If no KeyChain was valid, the original status won't
///     be changed.
/// </summary>
