...
public static class BlockSettingFactory
{
    ...
    public static BlockSetting CreateStringSetting(string name, string defaultValue = "",
        ...
        => new() {
            ...
            InterpolatedSetting = new InterpolatedStringSetting { Value = defaultValue, MultiLine = multiLine },
            FixedSetting = new StringSetting { Value = defaultValue, MultiLine = multiLine }
        };
    ...
    public static BlockSetting CreateListOfStringsSetting(string name, List<string> defaultValue = null,
        ...
        => new() {
            ...
            ReadableName = readableName ?? name.ToReadableName(),
            InputMode = mode,
            InterpolatedSetting = new InterpolatedListOfStringsSetting { Value = defaultValue ?? new List<string>() },
            FixedSetting = new ListOfStringsSetting { Value = defaultValue ?? new List<string>() }
        };
    ...
    public static BlockSetting CreateDictionaryOfStringsSetting(string name,
        ...
        => new() {
            ...
            InputMode = mode,
            InterpolatedSetting =
                new InterpolatedDictionaryOfStringsSetting { Value = defaultValue ?? new Dictionary<string, string>() },
            FixedSetting = new DictionaryOfStringsSetting { Value = defaultValue ?? new Dictionary<string, string>() }
        };
    ...
    {
        var setting =
            CreateDictionaryOfStringsSetting(name, null, SettingInputMode.Variable, readableName, description);
        setting.InputVariableName = variableName;
        return setting;
    }
}