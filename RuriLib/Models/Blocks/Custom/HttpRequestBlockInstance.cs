...
public class HttpRequestBlockInstance : BlockInstance
{
    ...
    public override string ToLC(bool printDefaultParams = false)
    {
        ...
        if (Safe) writer.AppendLine("SAFE", 2);
            ...
            if (line.StartsWith("TYPE:"))
                try
                {
                    ...
                    switch (reqParams)
                    {
                        case "STANDARD":
                            ...
                            lineCopy = line;
                            lineNumber++;
                            LoliCodeParser.ParseSettingValue(ref line, standardReqParams.Content,
                                new StringParameter());
                            ...
                            lineCopy = line;
                            lineNumber++;
                            LoliCodeParser.ParseSettingValue(ref line, standardReqParams.ContentType,
                                new StringParameter());
                        ...
                        case "BASICAUTH":
                            ...
                            lineCopy = line;
                            lineNumber++;
                            LoliCodeParser.ParseSettingValue(ref line, basicAuthReqParams.Username,
                                new StringParameter());
                            ...
                            lineCopy = line;
                            lineNumber++;
                            LoliCodeParser.ParseSettingValue(ref line, basicAuthReqParams.Password,
                                new StringParameter());
                        ...
                        case "MULTIPART":
                            ...
                            lineCopy = line;
                            lineNumber++;
                            LoliCodeParser.ParseSettingValue(ref line, multipartReqParams.Boundary,
                                new StringParameter());
                ...
                catch
                {
                    throw new LoliCodeParsingException(lineNumber,
                        $"Could not parse the setting: {lineCopy.TruncatePretty(50)}");
                }
                ...
                try
                {
                    ...
                    switch (tokenType)
                    {
                        case "STRING":
                            ...
                            LoliCodeParser.ParseSettingValue(ref line, stringContent.ContentType,
                                new StringParameter());
                ...
                {
                    throw new LoliCodeParsingException(lineNumber,
                        $"Could not parse the multipart content: {lineCopy.TruncatePretty(50)}");
                }
