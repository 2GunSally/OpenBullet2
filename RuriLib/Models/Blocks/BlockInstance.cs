...
public abstract class BlockInstance
{
    ...
    public Dictionary<string, BlockSetting> Settings { get; protected set; } = new();
    ...
    public virtual string ToCSharp(List<string> definedVariables, ConfigSettings settings) =>
