...
public static class TimeConverter
{
    ...
    {
        var dt = dateTime.Subtract(new DateTime(1970, 1, 1));
    ...
    public static DateTime ToDateTime(this string time, string format) =>
        DateTime.ParseExact(time, format, new CultureInfo("en-US"), DateTimeStyles.AllowWhiteSpaces)
            .ToUniversalTime();
    ...
    public static string ToISO8601(this DateTime dateTime) => dateTime.ToString("yyyy-MM-ddTHH\\:mm\\:ss.fffZ");
}