...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        // Localization
        var useCultureCookie = Configuration.GetSection("Culture").GetValue("UseCookie", false);
        ...
        services.Configure<RequestLocalizationOptions>(options =>
        {
            ...
            var supportedCultures = new[] {
                new CultureInfo("en"), new CultureInfo("it"), new CultureInfo("fr"), new CultureInfo("de"),
                new CultureInfo("es"), new CultureInfo("pt"), new CultureInfo("nl"), new CultureInfo("ru"),
                new CultureInfo("tr"), new CultureInfo("ro"), new CultureInfo("fa"), new CultureInfo("ar"),
                new CultureInfo("vi")
            };
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        if (RootChecker.IsRoot()) Console.WriteLine(RootUtils.RootWarning);
