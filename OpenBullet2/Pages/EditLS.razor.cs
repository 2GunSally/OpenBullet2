...
public partial class EditLS
{
    ...
    protected async override Task OnInitializedAsync()
    {
        ...
        if (config.Mode is not ConfigMode.Legacy) await js.AlertError(Loc["InvalidMode"], Loc["NotALegacyConfig"]);
    ...
    private async Task SaveScript() => config.LoliScript = await Editor.GetValue();
}