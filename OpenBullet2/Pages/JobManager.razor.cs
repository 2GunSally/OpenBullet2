...
public partial class JobManager : IDisposable
{
    ...
    protected async override Task OnInitializedAsync()
    {
        ...
        if (uid == 0)
        {
            ...
            foreach (var entity in entities) guests[entity.Id] = entity.Username;
        }
    }
    ...
    private void SelectJob(Job job) => Nav.NavigateTo($"job/{job.Id}");
    ...
    public async Task RemoveAll()
    {
        ...
        else
        {
            ...
            foreach (var job in Manager.Jobs.Where(j => j.OwnerId == uid)) Manager.RemoveJob(job);
        }
    }
