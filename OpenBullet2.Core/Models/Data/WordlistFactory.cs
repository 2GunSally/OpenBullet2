...
public class WordlistFactory
{
    ...
    public Wordlist FromEntity(WordlistEntity entity)
    {
        ...
        if (wordlistType == null) throw new InvalidWordlistTypeException(entity.Type);

        var wordlist =
            new Wordlist(entity.Name, entity.FileName, wordlistType, entity.Purpose, false) {
                Id = entity.Id, Total = entity.Total
            };
