...
public class ProxyClientHandler : HttpMessageHandler, IDisposable
{
        ...
        int redirects, CancellationToken cancellationToken = default)
    {
        ...
        if (UseCookies && CookieContainer == null) throw new ArgumentNullException(nameof(CookieContainer));
        ...
        CancellationToken cancellationToken)
    {
        ...
        return responseBuilder.GetResponseAsync(request, connectionCommonStream, ReadResponseContent,
            cancellationToken);
    }
