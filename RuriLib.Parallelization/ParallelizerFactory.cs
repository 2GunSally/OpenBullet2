...
public static class ParallelizerFactory<TInput, TOutput>
{
    ...
    ///     The maximum value that <paramref name="degreeOfParallelism" /> can assume when it is
    ///     changed with the <see cref="Parallelizer{TInput, TOutput}.ChangeDegreeOfParallelism(int)" /> method
    /// </param>
